...
Scoring or rating in educational assessment is similar to measurement in that both involve a systematic assignment of numbers (or logcial equivalents) to something of interest, be it an object, event, or abstract concept. It differs, however, from the classical notions of measurement in the following ways:
